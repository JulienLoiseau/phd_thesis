...
\newcommand{\phdTitleEN}{The choose of hybrids architectures, a realistic strategy to reach the Exascale}
...
%\printindex
\newgeometry{left=1cm,right=1cm,top=1.0cm,bottom=1.5cm}
