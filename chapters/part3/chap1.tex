...
A lot of work was spent on the comprehension of the physical aspects to produce a code that met the behavior of real astrophysics simulations.

The first section is a presentation of the SPH method and the overall limitation we face. 
Then we describe different types of specific simulations we used as a benchmark of the application. 
...
This implies the usage of a tree data structure, the work of our two metrics can be applied in this context. 
...
This tool will allow us to push forward and provide different type of accelerator in the future keeping a full transparency for the user.
