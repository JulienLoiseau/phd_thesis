...
In this chapter we give details on our choice for a generic complex system which confront us to several problematics. 
A complex system is a problem which gather several layers of complexity. 
In our case: the physics modelization and the computer science implementation with many sub-problems like computation and communication walls with underlying high irregularity. 
