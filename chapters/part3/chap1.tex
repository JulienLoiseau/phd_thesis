...
In order to target a complex problem targeting all the walls and confront classical architectures to hybrid ones the problem had to be very specific. 
...
\subsection{High number of data and specific formulations}
