...
\begin{figure}[t]
\centering
\includegraphics[width=.8\columnwidth]{\locpath/figures/sph/{sedov_flecsph_results}}
...
Several methods are possible with SPH we focused on the main ones, the mirror particles \cite{libersky1991smooth} or the dummies particles implementation \cite{adami2012generalized}. 

\begin{figure}[t!]
\centering
\begin{tikzpicture}[thick]
% Mathematical reflection
\draw (1,.5) circle (.25cm) node[pos=.5] (m1) {};
\draw[dashed] (2,.8) circle (.25cm) node[pos=.5] (m2) {};
\draw[dashed,->] (1,.5) -- (1.45,0) -- (2,.8);
\draw (0,0) -- (3,0);
\foreach \i in {1,...,6}{
...
% Mirror 
\draw (4.3,.6) circle (.25cm) node[pos=.5] (mi1) {};
\draw (5,.4) circle (.25cm) node[pos=.5] (mi2) {};
\draw (6.3,.8) circle (.25cm) node[pos=.5] (mi3) {};
\draw[black!50] (4.3,-.6) circle (.25cm) node[pos=.5] (mii1) {};
\draw[black!50] (5,-.4) circle (.25cm) node[pos=.5] (mii2) {};
\draw[black!50] (6.3,-.8) circle (.25cm) node[pos=.5] (mii3) {};
\draw[-] (mi1) -- (mii1);
\draw (4,0) -- (7,0);
\foreach \i in {1,...,6}{
...
% Dummies
\draw[black!50] (8.25,0) circle (.25cm) node[pos=.5] (d0) {};
\draw[black!50] (9.08,0) circle (.25cm) node[pos=.5] (d1) {};
\draw[black!50] (9.91,0) circle (.25cm) node[pos=.5] (d2) {};
\draw[black!50] (10.75,0) circle (.25cm) node[pos=.5] (d3) {};
% second layer
\draw[black!50] (8.66,-.5) circle (.25cm) node[pos=.5] (d4) {};
\draw[black!50] (9.50,-.5) circle (.25cm) node[pos=.5] (d5) {};
\draw[black!50] (10.33,-.5) circle (.25cm) node[pos=.5] (d6) {};
...
\end{tikzpicture}
\caption{Boundaries conditions with respectively: mathematics, mirror and dummies particles}
