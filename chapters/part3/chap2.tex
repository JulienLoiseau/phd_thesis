...
These tests have been done on 500,000 particles binary neutron star merging during the coalescence step, when the particles are very close. 
...
On the other hand, the scalability graph presents that the CPU version is more scalable than the GPU version. 
Indeed, the number of particles to handle by GPU get too small regarding their computational power and the transfers between CPU and GPU take a more important part of time. 
