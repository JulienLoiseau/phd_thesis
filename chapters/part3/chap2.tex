...
\begin{figure}[t!]
\centering
\includegraphics[width=.8\columnwidth]{\locpath/figures/flecsph/fmm_mac.png}
...
\begin{minipage}[b]{.5\textwidth}
	\centering
	\includegraphics[width=\textwidth]{\locpath/figures/flecsph/task_gpu.png}
	\caption{CPU-GPU tasks work balancing}
	\label{fig:cpu_gpu_rep}
\end{minipage}%
\begin{minipage}[b]{.5\textwidth}
\centering
	\includegraphics[width=\textwidth]{\locpath/figures/flecsph/scalability.png}
	\caption{CPU vs GPU scalability}
...
On figure~\ref{fig:cpu_gpu_scala} we find the strong scaling tests for CPU and GPU version using the empiric best depth of repartition.
