...
In this part we are going to face the computational wall on accelerators. 
In this case we used an academic problem known to be very irregular and heavy on computations. 
We show the optimizations made to the regular processor algorithm to efficiently implement this application on GPU. 

\section{The Langford problem}
