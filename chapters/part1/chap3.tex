...
When requested by the application, typically following the idea of \textit{divided-and-conquer} approach, the main thread will fork and then join other threads. \index{Divided-and-conquer approach}
