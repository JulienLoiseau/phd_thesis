...
\node[draw,minimum width=1cm,fill=black!50] (n11) at (1,\i) {5};
\node[draw,minimum width=1cm] (n12) at (2,\i) {2};
\node[draw,minimum width=1cm,fill=black!50] (n13) at (3,\i) {9};
\node[draw,minimum width=1cm] (n14) at (4,\i) {0};
\node[draw,minimum width=1cm,fill=black!50] (n15) at (5,\i) {0};
\node[draw,minimum width=1cm] (n16) at (6,\i) {3};
\node[draw,minimum width=1cm,fill=black!50] (n17) at (7,\i) {4};
\def\i{1.5}
\node[draw,minimum width=1cm] (n20) at (0,\i) {2};
\node[draw,minimum width=1cm,fill=black!50] (n21) at (1,\i) {5};
\node[draw,minimum width=1cm,fill=black!50] (n22) at (2,\i) {2};
\node[draw,minimum width=1cm,fill=black!50] (n23) at (3,\i) {9};
\node[draw,minimum width=1cm] (n24) at (4,\i) {0};
\node[draw,minimum width=1cm,fill=black!50] (n25) at (5,\i) {0};
\node[draw,minimum width=1cm,fill=black!50] (n26) at (6,\i) {3};
\node[draw,minimum width=1cm,fill=black!50] (n27) at (7,\i) {4};
\def\i{0}
\node[draw,minimum width=1cm] (n30) at (0,\i) {0};
\node[draw,minimum width=1cm,fill=black!50] (n31) at (1,\i) {5};
\node[draw,minimum width=1cm,fill=black!50] (n32) at (2,\i) {2};
\node[draw,minimum width=1cm,fill=black!50] (n33) at (3,\i) {9};
\node[draw,minimum width=1cm,fill=black!50] (n34) at (4,\i) {0};
\node[draw,minimum width=1cm,fill=black!50] (n35) at (5,\i) {0};
\node[draw,minimum width=1cm,fill=black!50] (n36) at (6,\i) {3};
\node[draw,minimum width=1cm,fill=black!50] (n37) at (7,\i) {4};
% Add the arrows 
...
\node[draw,minimum width=1cm,fill=black!50] (n11) at (12,\i) {5};
\node[draw,minimum width=1cm] (n12) at (13,\i) {11};
\node[draw,minimum width=1cm,fill=black!50] (n13) at (14,\i) {9};
\node[draw,minimum width=1cm] (n14) at (15,\i) {1};
\node[draw,minimum width=1cm,fill=black!50] (n15) at (16,\i) {0};
\node[draw,minimum width=1cm] (n16) at (17,\i) {7};
\node[draw,minimum width=1cm,fill=black!50] (n17) at (18,\i) {4};
\def\i{1.5}
\node[draw,minimum width=1cm] (n20) at (11,\i) {24};
\node[draw,minimum width=1cm,fill=black!50] (n21) at (12,\i) {5};
\node[draw,minimum width=1cm,fill=black!50] (n22) at (13,\i) {11};
\node[draw,minimum width=1cm,fill=black!50] (n23) at (14,\i) {9};
\node[draw,minimum width=1cm] (n24) at (15,\i) {8};
\node[draw,minimum width=1cm,fill=black!50] (n25) at (16,\i) {0};
\node[draw,minimum width=1cm,fill=black!50] (n26) at (17,\i) {7};
\node[draw,minimum width=1cm,fill=black!50] (n27) at (18,\i) {4};
\def\i{0}
\node[draw,minimum width=1cm] (n30) at (11,\i) {32};
\node[draw,minimum width=1cm,fill=black!50] (n31) at (12,\i) {5};
\node[draw,minimum width=1cm,fill=black!50] (n32) at (13,\i) {11};
\node[draw,minimum width=1cm,fill=black!50] (n33) at (14,\i) {9};
\node[draw,minimum width=1cm,fill=black!50] (n34) at (15,\i) {1};
\node[draw,minimum width=1cm,fill=black!50] (n35) at (16,\i) {0};
\node[draw,minimum width=1cm,fill=black!50] (n36) at (17,\i) {7};
\node[draw,minimum width=1cm,fill=black!50] (n37) at (18,\i) {4};
% Add the arrows 
\draw[->] (n00.south) -- (n10.north);
\draw[-] (n01.south) -- ([yshift=-.5cm]n01.south) -- ([yshift=-.5cm]n00.south);
\draw[->] (n02.south) -- (n12.north);
