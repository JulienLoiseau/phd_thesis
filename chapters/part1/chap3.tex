...
This model can be extended to programming models. 

\subsection{Parallel Random Access Machine}
The Parallel Random Access Machine, PRAM, is a model in which the global memory is shared between the processes and each process have its own local memory/registers.
...
This model is in opposition to PRAM because the synchronization between processes is made by communications. 
