...
This has to go with the description of interconnection network with the most used interconnection topologies. 
...
\index{Frequency}
A lot of new ways to produce smaller transistors had been discovered.
...
Indeed, as fast as the clock rate get, more operations can be performed in a second on the core. 
...
The idea of \textit{out-of-order} is to compute the instructions without following the Program Counter order. 
...
\caption{Multi-core CPU with 4 cores based on Von Neumann Model presented on figure~\ref{fig:1_HPC:von_neumann_model}}
